...
--새글쓰기
INSERT INTO
board1(boardno, title, writer, content,groupno,step,depth) 
 ...
 */
UPDATE board1 SET step = step + 1 WHERE step > 1 AND groupno = 582;
commit;
/*
 * 2. 
 * 	  boardno:시퀀스증가
 ...
 *    
 */
INSERT INTO board1(boardno,title,writer,content, groupno, step, depth) 
               VALUES
...
select * from board1 order by groupno desc;
